...
CATEGORY_URLS = [
    f"{BASE}/category-15826-Aerobatic--American-Champion.html",
    f"{BASE}/category-20306-Light-Sport--American-Champion.html",
]
...
def _debug_dump_hrefs(html: str, limit: int = 25) -> None:
    ...
    interesting = [h for h in hrefs if "classified" in h.lower() or "champion" in h.lower()]
