"""Scrape American Champion listings from Barnstormers.com and render them
...
PAGE_TITLE = "Other American Champion Ads on the Web"
...
EXTERNAL_SEARCH_LINKS = [
    ("Trade-A-Plane", "https://www.trade-a-plane.com/filtered/search?s-type=aircraft&s-keyword-search=american%20champion&s-original-search=american%20champion"),
    ("Controller", "https://www.controller.com/listings?keywords=american%20champion"),
    ("ASO", "https://aso.com/search?q=American%20Champion"),
]
...
<body>
  ...
  <div class="more-resources">
    <h2>Search More American Champion Listings</h2>
    <p>View additional American Champion Aircraft listings at these fine sites:</p>
