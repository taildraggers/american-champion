...
- Only whole-aircraft-for-sale listings are published. Each ad's title must match a
  recognized American Champion model code/name (7GCAA, 8KCAB, Super Decathlon,
  Citabria, Scout, Explorer, etc. - see `_MODEL_CODE_RE`/`_MODEL_NAME_RULES` in
  ...
  **`YEAR American Champion MODEL`** form when the ad states a model year (e.g.
  `1997 American Champion Super Decathlon`), or just **`American Champion MODEL`**
